      ...
      <div id="content">
        ...
        <div class="card shadow mx-4">
          <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-dark">Data User</h6>
          </div>
        </div>
                ...
                <div class="card card-dark">
                  <div class="card-body table-responsive">
                    <?php
                        ...
                        $pendapatan_sementara = 0;

                        foreach($pemesanan as $pm) {
                            foreach($jadwal as $jd) {
                                if($jd['id_jadwal'] == $pm['id_jadwal']) {
                                    $pendapatan_sementara += $jd['tarif'];
                                }
                            }
                        }
                    ?>

                    <b class="btn btn-block btn-success">Pendapatan Sementara   :  Rp. <?= number_format($pendapatan_sementara); ?> </b>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-success" href="<?= base_url('auth/logout') ?>">Ubah</a>
        </div>
      </div>
    </div>
  </div>
