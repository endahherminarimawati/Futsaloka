      ...
      <div id="content">
        ...
        <div class="card shadow mx-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Selamat Datang di Futsaloka!</h6>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="card-body">
                <p>Sekarang booking futsal ga perlu lagi datang ke tempat!, cukup daftar lewat online, dan datang pada hari H!</p>
                <p class="mb-0">Jika kamu ada saran terkait perbaikan ataupun suatu hal yang lain, jangan sungkan untuk email ya !</p>
              </div>
            </div>

            <div class="col-md-6">
              <img class="p-2 shadow img-fluid" src="<?= base_url('assets/image/galeri/lapangan1.jpg') ?>" alt="">
            </div>
          </div>
        </div>
        <!-- /.container-fluid -->
