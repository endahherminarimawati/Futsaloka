  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?= $this->session->flashdata('riwayat'); ?>


        <div class="card shadow p-2 mx-4">
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td> <a class="badge badge-danger" href="<?= base_url('user/dashboard/hapus/' . $pm['id_pemesanan'] ) ?>">Hapus</a> </td>
              </tr>
